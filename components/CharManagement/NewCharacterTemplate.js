...
const newCharacterTemplate = {
  ...
  stats:{
    STR: { legend:'STRENGTH', score:10, buffs:0, debuffs: 0 },
    DEX: { legend:'DEXTERITY', score:10, buffs:0, debuffs: 0 },
    CON: { legend:'CONSTITUTION', score:10, buffs:0, debuffs: 0 },
    INT: { legend:'INTELLIGENCE', score:10, buffs:0, debuffs: 0 },
    WIS: { legend:'WISDOM', score:10, buffs:0, debuffs: 0 },
  ...
  gear:{
    ARMOR:{NAME:'', TYPE:'', AC_BONUS:0, MAX_DEX:15, CHECK_PENALTY:0, SPELL_FAILURE:0, SPEED:9, WEIGHT:0, SPECIAL_PROPS:''},
    SHIELD:{NAME:'', AC_BONUS:0, CHECK_PENALTY:0, WEIGHT:0, SPECIAL_PROPS:'', SPELL_FAILURE:0},
    PROT_ITEM1:{NAME:'', AC_BONUS:0, WEIGHT:0, SPECIAL_PROPS:''},
    PROT_ITEM2:{NAME:'', AC_BONUS:0, WEIGHT:0, SPECIAL_PROPS:''},
    WEAPON1:weapon,
    WEAPON2:weapon,
    WEAPON3:weapon,
    WEAPON4:weapon,
